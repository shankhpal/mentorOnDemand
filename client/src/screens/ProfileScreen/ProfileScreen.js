...
const ProfileScreen = () => {
  ...
  const submitHandler = (e) => {
    ...
    dispatch(updateProfile({ name, email, password, pic,qualification,skill}));
  };
          ...
          <Col md={6}>
            <Form onSubmit={submitHandler}>
              ...
              <Form.Group controlId="pic">
                ...
                <div> 
                 <Form.Group controlId="qualitification">
              ...
              <Button type="submit" className='px-2' variant="outline-success">
                UPDATE
              </Button>
            </Form>
          </Col>
