              ...
              <div className="contact-box p-4">
                ...
                <form>
                  <div className="row">
                    ...
                    <div className="col-lg-12">
                      <button type="submit" onClick={()=>{ alert('Thank you for contacting us !!'); }} className="btn btn-danger-gradiant mt-3 mb-3 text-white border-0 py-2 px-3"><span> SUBMIT NOW <i className="ti-arrow-right"></i></span></button>
                    </div>
                  </div>
                </form>
              </div>
            </div>
            <div class="col-lg-4 bg-image bgimage">
